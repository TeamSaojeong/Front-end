...
const nowRoundedUp5 = () => { // 현재 시간 5분 단위로 올림
  const d = new Date();
...
const to24hStr = ({ am_pm, hour12, minute }) => { //12시간제 파츠를 "HH:MM" 24시간 문자열로
...
//비교 / 보정
const compareTime = (a, b) => { // 두 시간 파츠 a가 b보다 이전인지 비교
  if (a.am_pm !== b.am_pm) // 오전 오후 다르면 
