...
const ConfirmFilePage = ({onNext}) => {
    ...
    return(
        ...
        <div>
            <h1 className="cf-title">내 주차 장소 등록을 위한 <br/>필수 확인</h1>
            <p className="cf-desc">개인 소유 주차 장소인지 확인할 수 있도록
                <br/><span className="cf-desc-point">토지, 건물 관계 입증 서류</span>를 준비해주세요.
                <br/>EX) 토지매매서, 임대계약서
            </p>
        </div>
